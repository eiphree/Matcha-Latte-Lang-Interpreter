...
-- | The abstract syntax of language matchalatte.

module Lang.AbsMatchalatte where
...
data TopDef' a
    = FnDef a (Type' a) Ident [Arg' a] (Block' a) | GlbDcl a (Decl' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
data Decl' a = Dcl a (Type' a) [Item' a]
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
